...
<div class="admin_page">
	...
	<div class="menu_bar">
		<div class="menu_item" <?php if($_GET['p'] == 0){echo "style='background:  #acacac; color: white;'";}else{echo " onclick=\"href('?p=0')\"";} ?>>Services</div>
		<div class="menu_item" <?php if($_GET['p'] == 1){echo "style='background:  #acacac; color: white;'";}else{echo " onclick=\"href('?p=1')\"";} ?>>Opening Hours</div>
		...
		<div class="menu_item" <?php if($_GET['p'] == 4){echo "style='background:  #acacac; color: white;'";}else{echo " onclick=\"href('?p=4')\"";} ?>>Gallery</div>
	...
	<div class="admin_settings">
		<?php 
			if ($_GET['p'] == 0) {
				...
				require_once 'admin-opening-hours.php';
			}elseif ($_GET['p'] == 2) {
