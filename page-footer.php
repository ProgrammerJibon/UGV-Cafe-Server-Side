<a href="https://api.whatsapp.com/send?phone=<?php echo $info['whatsapp']; ?>" target="_blank" class="floating whatsapp">
	<i class="fab fa-whatsapp float-button"></i>
</a>
<a href="//<?php echo $info['instagram']; ?>" target="_blank" class="floating whatsapp" style="bottom: calc(10% + 70px);background: linear-gradient(45deg, #ff53a3, #f10070);">
	<i class="fab fa-instagram float-button"></i>
</a>
<a href="#top" id="scroll_to_top_arrow_btn">
